...
<?php include 'nav.php'; ?>
<h5 style="text-align: center;margin-top: 20px;">Users</h5>
...
">
      <tr>
          ...
          <td> <font style="font-family: sans-serif;font-weight: bold;">Name</font> </td>
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr>
                  ...
                  <td>'.$field2name.'</td>
                  <td>'.$field3name.'</td>
                  <td> <a href="http://localhost/wtlproject/admin/delete2.php?email='.$field3name.'">Delete </td>
              </tr>';
    }
    $result->free();
}
